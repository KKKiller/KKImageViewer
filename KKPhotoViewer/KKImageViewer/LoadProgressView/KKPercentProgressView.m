...
@implementation KKPercentProgressView
...
- (void)drawRect:(CGRect)rect
{
    ...
    CGFloat radius = MIN(rect.size.width * 0.5, rect.size.height * 0.5) - KKProgressViewItemMargin * 0.2;
    ...
    // 遮罩
    [KKColorMaker(240, 240, 240, 1) set];
    ...
    attributes[NSFontAttributeName] = [UIFont boldSystemFontOfSize:20 * KKProgressViewFontScale];
