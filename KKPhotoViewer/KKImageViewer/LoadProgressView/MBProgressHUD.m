...
+ (void)showMessage:(NSString *)message onView:(UIView *)view{
    [MBProgressHUD showMessage:message onView:view duration:2.0 alpha:0.8];
}
+ (void)showMessage:(NSString *)message onView:(UIView *)view duration:(float)duration alpha:(float)alpha{
